...
rankingFactorForStrategy(whiteBird,10).
rankingFactorForStrategy(depot,9).
rankingFactorForStrategy(tnt,).

rankingFactorForStrategy(heavyObject,9).
rankingFactorForStrategy(roof, 8).
rankingFactorForStrategy(minPen, 7).
rankingFactorForStrategy(maxPen, 6).
rankingFactorForStrategy(pigCont, 1).
rankingFactorForStrategy(destroyPrimitive, 2).
